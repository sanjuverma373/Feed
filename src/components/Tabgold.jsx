...
import circleSvg from '../assets/images/svg/circleSvg.svg';
                        ...
                        <div className=' mt-[62px] max-w-[361px] mx-auto relative z-[1]'>
                                ...
                                <div className=' rounded-lg p-4 bg-[#F0FDF4] border-[1px] border-solid shadow-[4px_4px_0px_0px_#0C0A0980_inset] border-[#052E1633] max-h-[95px] '>
                                        <div className=' flex justify-between items-center '>
                                                <p className=' font-normal text-base leading-5 text-[#052E1680] font-Inter'>You pay</p>
                                                <p className=' font-normal text-xs leading-[14.52px] text-[#052E16] tracking-[1%] font-Inter'>0.25 balance</p>
                                        </div>
                                        <div className=' flex justify-between items-center'>
                                                <p className=' font-semibold text-[40px] leading-[48.41px] text-black font-Inter'>0.1</p>
                                                <div className=' p-1 flex items-center justify-between rounded bg-[#052E161A] font-normal text-xs font-Inter leading-[14.52px] text-[#052E16] tracking-[1%] w-[61px]'>
                                                        <img src={circleSvg} alt="dimondSvg" />
                                                        <span>pGold</span>
                                                </div>
                                        </div>
                                </div>
                                <div className=' rounded-lg p-4 bg-[#F0FDF4] border-[1px] border-solid shadow-[4px_4px_0px_0px_#0C0A0980_inset] border-[#052E1633] max-h-[92px] mt-3 '>
                                        <p className=' font-normal text-base leading-5 text-[#052E1680] font-Inter'>You receive</p>
                                        <div className=' flex justify-between items-center'>
                                                <p className=' font-semibold text-[40px] leading-[48.41px] text-black font-Inter'>256.25</p>
